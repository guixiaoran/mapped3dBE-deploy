...
var STATUS_MSG = {
  ERROR: {
    ...
    NOT_REGISTERED: {
      statusCode: 400,
      customMessage: "You are not registered with Us. Kindly register yourself to avail services!",
      type: "NOT_REGISTERED"
    },
...
var CUSTOM_ERROR_404 = function CUSTOM_ERROR_404(msg) {
  return {
    statusCode: 404,
...
var CUSTOM_ERROR = function CUSTOM_ERROR(msg, statusCode) {
  return {
